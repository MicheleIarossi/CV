...
\cvheaderline{\textbf{Expert}}{\textbf{Elektrobit (Germany)}}{\textbf{2012 -- \hspace{4ex} }}
\begin{cvlist}[]
\item Develop software for automotive electronic control units based on the AUTOSAR standard
\end{cvlist}
\medskip
\cvheaderline{\textbf{Software Engineer}}{\textbf{Magneti Marelli / Da Vinci Engineering (Germany)}}{\textbf{2009 -- 2012}}
\begin{cvlist}[]
\item Developed software for automotive instrument clusters based on double microcontroller architecture
\end{cvlist}
\medskip
\cvheaderline{\textbf{Software Engineer}}{\textbf{Dune (Italy)}}{\textbf{2001 -- 2009}}
\begin{cvlist}[]
